...
const Home: React.FC = () => {
  ...
  // Memoize the FAQ data to prevent recreation on each render
  ...
  // Wrap toggleFAQ in useCallback to prevent recreation on each render
